...
namespace main
{
    public class Maze
    {
        ...
        private bool MoveUp(Position currentPosition)
        {
            ...
            Console.WriteLine(
                $"→ Moved to up \t from [{currentPosition.Column},{currentPosition.Row}] to [{nextPosition.Column},{nextPosition.Row}]");
        ...
        private bool MoveRight(Position currentPosition)
        {
            ...
            _path.Add(nextPosition);
            Console.WriteLine(
                $"→ Moved to right \t from [{currentPosition.Column},{currentPosition.Row}] to [{nextPosition.Column},{nextPosition.Row}]");
        ...
        private bool MoveDown(Position currentPosition)
        {
            ...
            _path.Add(nextPosition);
            Console.WriteLine(
                $"→ Moved to down \t from [{currentPosition.Column},{currentPosition.Row}] to [{nextPosition.Column},{nextPosition.Row}]");
        ...
        private bool MoveLeft(Position currentPosition)
        {
            ...
            _path.Add(nextPosition);
            Console.WriteLine(
                $"→ Moved to left: \t from [{currentPosition.Column},{currentPosition.Row}] to [{nextPosition.Column},{nextPosition.Row}]");
